...
public class ElasticToResponseModelTransformer {
    ...
    public ElasticQueryServiceResponseModel getResponseModel(
            TwitterIndexModel twitterIndexModel) {
    ...
    public List<ElasticQueryServiceResponseModel> getResponseModels(
